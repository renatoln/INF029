...
void testeListar()
{
    ...
    printf("%d\n", getDadosEstruturaAuxiliar(1, vet, tamanhoVet) == SEM_ESTRUTURA_AUXILIAR);
    printf("%d\n", getDadosEstruturaAuxiliar(11, vet, tamanhoVet) == POSICAO_INVALIDA);
    printf("%d\n", getDadosEstruturaAuxiliar(2, vet, tamanhoVet) == SUCESSO);

    printf("%d\n", vet[0] == 7);
    printf("%d\n", vet[1] == -9);

    printf("%d\n", getDadosOrdenadosEstruturaAuxiliar(1, vet, tamanhoVet) == SEM_ESTRUTURA_AUXILIAR);
    printf("%d\n", getDadosOrdenadosEstruturaAuxiliar(11, vet, tamanhoVet) == POSICAO_INVALIDA);
    printf("%d\n", getDadosOrdenadosEstruturaAuxiliar(2, vet, tamanhoVet) == SUCESSO);
...
void testeRetornarTodosNumeros()
{
    ...
    int vet1[2];
    int tamanhoVet1 = 2;
    printf("%d\n", getDadosDeTodasEstruturasAuxiliares(vet1, tamanhoVet1) == TODAS_ESTRUTURAS_AUXILIARES_VAZIAS);

    printf("%d\n", getDadosOrdenadosDeTodasEstruturasAuxiliares(vet1, tamanhoVet1) == TODAS_ESTRUTURAS_AUXILIARES_VAZIAS);
...
*/
    ...
    printf("%d\n", getDadosDeTodasEstruturasAuxiliares(vet, tamanhoVet) == SUCESSO);
    ...
    printf("%d\n", getDadosOrdenadosDeTodasEstruturasAuxiliares(vet2, tamanhoVet2) == SUCESSO);
